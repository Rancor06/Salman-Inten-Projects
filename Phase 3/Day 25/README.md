...
|---|---|
| ![Students page](screenshots/students.png) | ![Student detail page](screenshots/student-detail.png) |

| Reports | Settings |
|---|---|
| ![Reports page](screenshots/reports.png) | ![Settings page](screenshots/settings.png) |
